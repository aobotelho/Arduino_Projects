...
String UPDATE_TOPIC;
//This is the specific topic in whic the server will send a reset message to a specific node
#define RESET_TOPIC_DEF "/update/reset/"
String RESET_TOPIC;
//This is the specific topic in whic the server will send a reset message to all nodes
#define RESET_SYSTEM_TOPIC_DEF "/update/reset/"
String RESET_SYSTEM_TOPIC = RESET_SYSTEM_TOPIC_DEF;
...
void setup(){
  ...
  client.subscribe((char*)RESET_SYSTEM_TOPIC.c_str());
  #if USE_SERIAL
    Serial.println("Subscribing to: ");
    Serial.println(STATUS_TOPIC);
    Serial.println(UPDATE_TOPIC);
    Serial.println(RESET_TOPIC);
    Serial.println(RESET_SYSTEM_TOPIC);
  #endif
}
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  else if(String(topic) == RESET_SYSTEM_TOPIC){
    #if USE_SERIAL
      Serial.println("Resetting! ..... See you soon x)");
    #endif
    delay(10);
